...
* In GitHub (remote):
  - Refer to .githooks README [here](https://github.com/weecology/PortalData/blob/main/.githooks/README.md) and this only needs to be done once, and the readme explains how to use the version tags. Version tags will be needed when a new commit is done.
